...
const TEST_USERS = [
  { email: 'admin@bankingsystem.com', password: 'Secure!2024$Bank#Mgr' },
  { email: 'user1@test.com', password: 'Verify!2024$Safe#U1' },
  { email: 'user2@test.com', password: 'Check!2024$Valid#U2' },
];
